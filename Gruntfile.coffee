...
module.exports = (grunt) ->
  ...
  opts = {
    base_path: '_site/bone-age',
    js_path: '_site/bone-age/vendor/js/',
    css_path: '_site/bone-age/vendor/css/',
    font_path: '_site/bone-age/vendor/fonts/',
    image_path: '_site/bone-age/vendor/images/',
  }
